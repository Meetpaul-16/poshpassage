...
"[project]/app/site-client.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SiteClient() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SiteClient.useEffect": ()=>{
            const root = document.body;
            const header = root.querySelector(".site-header");
            const toggle = root.querySelector(".nav-toggle");
            const scroll = {
                "SiteClient.useEffect.scroll": ()=>header?.classList.toggle("is-scrolled", window.scrollY > 8)
            }["SiteClient.useEffect.scroll"];
            const closeNav = {
                "SiteClient.useEffect.closeNav": ()=>{
            ...
            const toggleNav = {
                "SiteClient.useEffect.toggleNav": ()=>{
            ...
            const observer = "IntersectionObserver" in window ? new IntersectionObserver({
                "SiteClient.useEffect": (entries)=>{
                    entries.forEach({
                        "SiteClient.useEffect": (entry)=>{
            ...
            root.querySelectorAll(".reveal").forEach({
                "SiteClient.useEffect": (element)=>{
                    observer ? observer.observe(element) : element.classList.add("in");
                }
            }["SiteClient.useEffect"]);
            root.querySelectorAll("[data-year]").forEach({
                "SiteClient.useEffect": (element)=>{
                    element.textContent = new Date().getFullYear();
                }
            }["SiteClient.useEffect"]);
            const here = window.location.pathname.replace(/\/$/, "") || "/";
            root.querySelectorAll(".nav-primary a[href]").forEach({
                "SiteClient.useEffect": (anchor)=>{
                ...
                "SiteClient.useEffect": (name)=>{
                    ...
                    if (value && select) {
                        select.value = [
                            ...
                            "SiteClient.useEffect": (option)=>option.value.toLowerCase() === value.toLowerCase()
                        }["SiteClient.useEffect"])?.value || "";
                    }
                }
            }["SiteClient.useEffect"]);
            ...
            const submitForm = {
                "SiteClient.useEffect.submitForm": (form, endpoint, successMessage, buttonLabel)=>({
                        "SiteClient.useEffect.submitForm": async (event)=>{
                    ...
                    })["SiteClient.useEffect.submitForm"]
            }["SiteClient.useEffect.submitForm"];
            ...
            const singleOpen = {
                "SiteClient.useEffect.singleOpen": (event)=>{
                    if (event.currentTarget.open) details.forEach({
                        "SiteClient.useEffect.singleOpen": (item)=>{
                            if (item !== event.currentTarget) item.open = false;
                        }
                    }["SiteClient.useEffect.singleOpen"]);
                }
            }["SiteClient.useEffect.singleOpen"];
            details.forEach({
                "SiteClient.useEffect": (item)=>item.addEventListener("toggle", singleOpen)
            }["SiteClient.useEffect"]);
            return ({
                "SiteClient.useEffect": ()=>{
                    ...
                    details.forEach({
                        "SiteClient.useEffect": (item)=>item.removeEventListener("toggle", singleOpen)
                    }["SiteClient.useEffect"]);
                    document.body.style.overflow = "";
                }
            })["SiteClient.useEffect"];
...
_s(SiteClient, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = SiteClient;
var _c;
__turbopack_context__.k.register(_c, "SiteClient");
...
//# sourceMappingURL=_120s9g4._.js.map